...
Step 4: Use d3 to append 1 cell per ufo observation value (Date, City, State, Country, Shape)
Step 5: Use d3 to update each cell's text with ufo observation values (Date, City, State, Country, Shape)
*/
function populateTable(dataEntry, tbodyObject) {
    ...
    Object.entries(dataEntry).forEach(([key, value]) => {
        ...
        // ufo observation values (Date, City, State, Country, Shape)
        cell.text(value);
    });
};
